...
--Q2: With the data available in the tech_salries table, please check for the average salary for a software engineer with
--    great experience and working in a full-time position at a tech company in the United States region?  AUTHOR - Myself
...
--Q3: In four areas of concern for the company, the cost of living has increased substantially in the pas six months and is now compared to
--    that of San Francisco environs. As a result some employees have protested silently for a raise in their pay. For potential decision 
--    making on raise and study sake, please provide me with the difference in the average salary between tech employees who work in Nigeria,  
--    India, France and Great Britain areas as compared to the US?  AUTHOR - Myself
--A3: To answer the above question, hence the code below:

SELECT AVG(salary_in_usd) AS average_salary, company_location
FROM computerscience_salaries
WHERE company_location IN ('US', 'NG', 'IN', 'FR', 'GB')
